...
--meist beginnen mit sys.dm_os_ oder sys.dm_db_


--OS_WAIT STATS_ Ausgabe der Waetezeiten auf Ressourcen
--eine der wichtigsten Sichten

select * from sys.dm_os_wait_stats

--ABF----->QUEUE--> Worker ---> ? Log --->

--0---------------------70ms----------100ms

--100-70 = Signal Zeit  = CPU max 25%   30ms 

--Zeiten sind kummulierend
...
--Brent Ozar  First Responder Kit.. sp_blitzIndex
